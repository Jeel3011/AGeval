...
export default function Landing() {
  return (
    <div className="ag-canvas min-h-screen text-zinc-900">
      ...
      <section className="relative z-10 mx-auto max-w-6xl px-6 pt-10 pb-6 md:pt-16">
        <div className="mx-auto max-w-3xl text-center">
          <div className="inline-flex items-center gap-2 rounded-full glass px-3 py-1 text-[12px] text-zinc-600 mb-6">
          ...
          <p className="mt-5 text-base md:text-lg text-zinc-500 leading-relaxed max-w-2xl mx-auto">
            ...
            with reliability, efficiency and agentic metrics.
          </p>
        ...
        {/* Live demo */}
        <div id="demo" className="mt-12 md:mt-16 scroll-mt-24">
          <LiveDemo />
      ...
      <section id="frameworks" className="relative z-10 mx-auto max-w-6xl px-6 py-16 scroll-mt-20">
        ...
        <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
          {FRAMEWORKS.map((f) => (
            <div key={f.name} className="glass rounded-xl p-4 flex items-center gap-3.5">
      ...
      {/* Metrics + integration */}
      <section id="metrics" className="relative z-10 mx-auto max-w-6xl px-6 pb-16 scroll-mt-20">
...
# → result["episode_id"] is now scored`}
        ...
        <div className="mt-10 glass-dark rounded-2xl p-8 text-center text-white">
